...
/* prototypes */
/* interesting this example didn't work with the name 'getline' */
/* apparently a getline function has been added to stdio since 1988 :) */
/* name changed to getliner to reflect that */
